...
@section('content')
    <div class="content">
        <form method="post" action="{{route('admin.salers.update')}}" class="form-horizontal" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-8">
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control" value="{{$saler->name}}">
                                        {{--<span class="form-text">A block of help text that breaks onto a new line.</span>--}}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <input type="text" name="location" class="form-control" value="{{$saler->location}}">
                                        {{--<span class="form-text">A block of help text that breaks onto a new line.</span>--}}
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <span class="btn-group bootstrap-select p-0 col-md-3">
                                           <select class="selectpicker" data-size="7" data-style="btn btn-info"
                                                   title="Sắp xếp theo" tabindex="-98" id="" name="type">
                                            <option class="bs-title-option" value="">Trạng thái</option>
